(function(){
    let options = chrome.storage.sync.get(["options"], function(o){
    ...
    document.getElementById("test-online-url").addEventListener('click', function(){
        let onlineUrl = document.getElementById("online-url").value;
        handleUrlTestResult(sendRequest(onlineUrl));
    });

    document.getElementById("test-offline-url").addEventListener('click', function(){
    ...
    document.getElementById("save-config").addEventListener('click', function(){
        ...
        chrome.storage.sync.set({options: formOptions}, function(){
            showToast("changes-saved-toast");
        });
    });
